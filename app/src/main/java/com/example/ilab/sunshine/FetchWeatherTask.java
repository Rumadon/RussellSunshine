...
import com.example.ilab.sunshine.data.WeatherContract;
...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    public void getWeatherDataFromJson(String forecastJsonStr, int numDays
        ...
        double cityLatitude = cityCoord.getLong(OWM_COORD_LAT);
        double cityLongitude = cityCoord.getLong(OWM_COORD_LONG);
    ...
    protected Void doInBackground(String... params) {
        ...
        try {
            ...
            URL url = new URL(uri.toString());      //http://api.openweathermap.org/data/2.5/forecast/daily?q=Boston&mode=json&units=metric&cnt=7
